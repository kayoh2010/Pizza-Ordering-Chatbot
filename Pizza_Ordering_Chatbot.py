...
while keepGoing.lower() == "y":
    ...
    if total >= 50:
        print("\nCongradulations!! You've been rewarded a $10 off coupon for your next order!")
    else:
        print("\nOrders over $50 will recieve a free $10 off coupon to use on your next order.")
    print("\n---------------")
